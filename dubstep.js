//DUBSTEP FUNCTION...used Florin-pop.com jcc dubstep as a reference
...
// this song, Polycarpus inserts a certain number of words "WUB" before the first word of the song (the number may 
// be zero), after the last word (the number may be zero), and between words (at least one between any pair of 
...
// Example: songDecoder("WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB") will return: 
// WE ARE THE CHAMPIONS MY FRIEND


//ORIGINAL SOLUTION:
const songDecoder = (song) => {
    let songReduce = song.split('WUB').filter(el => el !== '').join(' ');
    return songReduce;
}
...
// //REFACTORED VERSION:
// const songDecoder = (song) => {
//     return songReduce = song.split('WUB').filter(el => el !== '').join(' ');
// }
// console.log(songDecoder('WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDWUB'));
...
// //BEAST MODE:
// const songDecoder = (song) => song.split('WUB').filter(el => el !== '').join(' ');
// console.log(songDecoder('WUBWEWUBAREWUBWUBTHEWUBCHAMPIONSWUBMYWUBFRIENDSWUB'));